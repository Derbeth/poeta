...
require './test/tc_dictionary_statistics'
require './test/tc_controlled_dictionary'
require './test/tc_smart_random_dictionary'
require './test/tc_sentence'
require './test/tc_sentence_manager'
require './test/tc_verse'
require './test/tc_poem'
require './test/tc_poem_files'
